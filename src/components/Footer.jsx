    ...
    <footer className="bg-[#03344F] text-white py-12 ">
      <div className="max-w-7xl max-auto px-4 md:px-8 md:grid-cols-3 grid gap-12 ">
        <div className="pl-[50px]">
          <h2 className="text-[#ffffff] text-xl font-bold  mb-4 ">
            SHINE LUXURY FURNITURE
          </h2>
          <p className="text-sm text-gray-100 mb-7 ">
            At Shine Luxury Furniture, beauty goes beyond the surface. We're
            here to help you feel confident, radiant, and empowered every day.
            Have questions or want to share your glow-up journey? Connect with
            us on social media for tips, tutorials, and exclusive updates.
          </p>
        ...
        <div className="">
          ...
          <ul className="space-y-1 text-sm text-gray-300">
            ...
            <li className="hover:text-[#ffffff] cursor-pointer text">
              Terms of Services
            </li>
          </ul>
        </div>
